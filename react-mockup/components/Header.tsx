...
import { Search, ShoppingCart, User, Menu, X, Home, Info, Phone } from 'lucide-react';
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            {/* Cart */}
            <motion.button
              className="relative flex items-center space-x-1 hover:text-gray-300 transition-colors"
              whileHover={{ scale: 1.05 }}
            >
            ...
            >
              <div className="px-4 py-4 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <a href="#" className="block py-2 hover:text-gray-300 transition-colors flex items-center">
                  ...
                  {user.isAuthenticated ? (
                    ...
                    <>
                      ...
                      <a href="#" className="block py-2 bg-blue-600 hover:bg-blue-700 rounded text-center transition-colors">
                        Register
                      </a>
                    </>
                  )}
